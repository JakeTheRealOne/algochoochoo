...
//     System.out.println("[Dijkstra] : Construction en " + duration /
//     1000000000f
//         + " secondes");

//     start = System.nanoTime();
//     List<Edge> path1 = algo.dijkstra("AUMALE", "FRAITEUR", 7 * 3600 + 0 *
//     60); end = System.nanoTime(); duration = end - start;
//     System.out.println("[Dijkstra] : Requete #1   en " + duration /
//     1000000000f
//         + " secondes");
//     start = System.nanoTime();
//     List<Edge> path2 = algo.dijkstra("Antwerpen Centraal Station",
...
//     end = System.nanoTime();
//     duration = end - start;
//     System.out.println("[Dijkstra] : Requete #2   en " + duration /
//     1000000000f
//         + " secondes");
//     start = System.nanoTime();
//     List<Edge> path3 = algo.dijkstra(
...
//     end = System.nanoTime();
//     duration = end - start;
//     System.out.println("[Dijkstra] : Requete #3   en " + duration /
//     1000000000f
//         + " secondes");
//     start = System.nanoTime();
...
//     end = System.nanoTime();
//     duration = end - start;
//     System.out.println("[Dijkstra] : Requete #4   en " + duration /
//     1000000000f
//         + " secondes");
//   }
// }
