 ...
 *       for consistency with {@link StdIn}, {@link
 * Double#parseDouble(String)}, and floating-point literals. <li> {@code
 * StdOut} <em>flushes</em> standard output after each call to
